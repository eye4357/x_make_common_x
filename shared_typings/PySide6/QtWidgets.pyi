...
from .QtCore import QObject, QPoint, Signal
...
class QLayout(QObject):
    def addWidget(self, widget: "QWidget", stretch: int = ..., alignment: int = ...) -> None: ...
...
class QWidget(QObject):
    ...
    def setSizePolicy(self, horizontal: int | QSizePolicy, vertical: int | QSizePolicy | None = ...) -> None: ...
...
class QDialogButtonBox(QWidget):
    ...
    def __init__(self, buttons: int = ..., orientation: int = ..., parent: QWidget | None = ...) -> None: ...
...
class QTreeWidgetItem:
    ...
    @overload
    def __init__(self, parent: "QTreeWidget", strings: Iterable[str], type: int = ...) -> None: ...
...
class QMessageBox:
    ...
    @staticmethod
    def question(parent: QWidget | None, title: str, text: str) -> "QMessageBox.StandardButton": ...
